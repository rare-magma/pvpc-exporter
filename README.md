...
1. Run it.
  ...
  ```bash
    docker run --rm --tty --interactive --read-only --cap-drop ALL --security-opt no-new-privileges:true --cpus 2 -m 64m --pids-limit 16 --volume ./pvpc_exporter.json:/tmp/pvpc_exporter.json:ro ghcr.io/rare-magma/pvpc-exporter:latest
  ```
